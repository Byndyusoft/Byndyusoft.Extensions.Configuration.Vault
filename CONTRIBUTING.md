# Contributing to Byndyusoft.Extensions.Configuration.Vault
...
If you want to fix, to add enhancement, or to improve documentation, you need to learn how to work with GitHub, Byndyusoft.Extensions.Configuration.Vault code base and contributing rules.
...
```shell
 git clone https://github.com/Byndyusoft/Byndyusoft.Extensions.Configuration.Vault.git
```
